   ...
   return (() => {
       var n = {
               ...
               153: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, "/* Container */\n\n.guifyv2-panel-container {\n    position: absolute;\n    background: var(--color-panel-background);\n}\n\n.guifyv2-panel-container-scrollable {\n    max-height: calc(100% - var(--size-menu-bar-height));\n    overflow: scroll;\n}\n\n/* Container modes (i.e. inner, outer) */\n\n.guifyv2-panel-container-right-inner {\n    right: 0;\n    left: unset;\n}\n\n.guifyv2-panel-container-left-inner {\n    right: unset;\n    left: 0;\n}\n\n.guifyv2-panel-container-right-outer {\n    right: unset;\n    left: 100%;\n}\n\n.guifyv2-panel-container-left-outer {\n    right: 100%;\n    left: unset;\n}\n\n.guifyv2-fullscreen .guifyv2-panel-container-right-inner,\n.guifyv2-fullscreen .guifyv2-panel-container-right-outer {\n    right: 0;\n    left: unset;\n}\n\n.guifyv2-fullscreen .guifyv2-panel-container-left-inner,\n.guifyv2-fullscreen .guifyv2-panel-container-left-outer {\n    right: unset;\n    left: 0;\n}\n\n/* Panel (in container) */\n\n.guifyv2-panel {\n    padding: 14px;\n    /* Last component will have a margin, so reduce padding to account for this */\n    padding-bottom: calc(14px - var(--size-component-spacing));\n\n    /* all: initial;  */\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n    cursor: default;\n    text-align: left;\n    box-sizing: border-box;\n}\n\n.guifyv2-panel.guifyv2-panel-hidden {\n    height: 0px;\n    display: none;\n}\n\n.guifyv2-panel * {\n    box-sizing: content-box;\n    box-sizing: initial;\n    -webkit-box-sizing: initial;\n    -moz-box-sizing: initial;\n}\n\n.guifyv2-panel input {\n    display: inline;\n}\n\n.guifyv2-panel a {\n    color: inherit;\n    text-decoration: none;\n}\n\n.guifyv2-panel-toggle-button {\n    position: absolute;\n    top: 0;\n    margin: 0;\n    padding: 0;\n    width: 15px;\n    height: 15px;\n    line-height: 15px;\n    text-align: center;\n    border: none;\n    cursor: pointer;\n    font-family: inherit;\n    color: var(--color-text-primary);\n    background-color: var(--color-component-background);\n\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n\n}\n\n/* Open/Close button styling */\n.guifyv2-panel-toggle-button svg {\n    fill-opacity: 0;\n    stroke-width: 3;\n    stroke: var(--color-component-foreground);\n}\n\n/* Remove browser default outlines since we're providing our own */\n.guifyv2-panel-toggle-button:focus {\n    outline:none;\n}\n.guifyv2-panel-toggle-button::-moz-focus-inner {\n    border: 0;\n}\n\n.guifyv2-panel-toggle-button:hover,\n.guifyv2-panel-toggle-button:focus {\n    color: var(--color-text-hover);\n    background-color: var(--color-component-foreground);\n}\n\n.guifyv2-panel-toggle-button:active {\n    color: var(--color-text-active);\n    background-color:var(--color-component-active);\n}", "", {
                       version: 3,
               ...
               56: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ".guifyv2-toast-notification {\n    box-sizing: border-box;\n    position: relative;\n    width: 100%;\n    /* height: 20px; */\n    padding: 8px;\n    padding-left: 20px;\n    padding-right: 20px;\n    text-align: center;\n\n    font-family: var(--font-family);\n    font-size: var(--font-size);\n    font-weight: var(--font-weight);\n}\n\n.guifyv2-toast-area .guifyv2-toast-notification:nth-child(odd) {\n    color: var(--color-text-primary);\n    background-color:var(--color-panel-background);\n}\n\n.guifyv2-toast-area .guifyv2-toast-notification:nth-child(even) {\n    color: var(--color-text-primary);\n    background-color: var(--color-menu-bar-background);\n}\n\n.guifyv2-toast-close-button {\n    color: var(--color-text-primary);\n    background: transparent;\n    position: absolute;\n    text-align: center;\n    margin-top: auto;\n    margin-bottom: auto;\n    border: none;\n    cursor: pointer;\n    top: 0;\n    bottom: 0;\n    right: 8px;\n}", "", {
                       version: 3,
               ...
               142: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ".guifyv2-component-label {\n    left: 0;\n    width: calc(var(--size-label-width) - 2%);\n    display: inline-block;\n    margin-right: 2%;\n    vertical-align: top;\n    min-height: var(--size-component-height);\n    line-height: var(--size-component-height);\n\n    color: var(--color-text-primary);\n}\n\n/* Disabled styles */\n.disabled .guifyv2-component-label {\n    color: var(--color-text-disabled);\n}", "", {
                       version: 3,
               ...
               351: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ".guifyv2-button {\n    box-sizing: border-box !important;\n    color: var(--color-text-secondary);\n    background-color: var(--color-component-background);\n\n    position: absolute;\n    text-align: center;\n    height: var(--size-component-height);\n    line-height: var(--size-component-height);\n    padding-top: 0px;\n    padding-bottom: 0px;\n    width: calc(100% - var(--size-label-width));\n    border: none;\n    cursor: pointer;\n    right: 0;\n    font-family: inherit;\n}\n\n.guifyv2-button:focus {\n    outline:none;\n}\n.guifyv2-button::-moz-focus-inner {\n    border:0;\n}\n\n.guifyv2-button:hover,\n.guifyv2-button:focus {\n    color: var(--color-text-hover);\n    background-color: var(--color-component-foreground);\n}\n\n.guifyv2-button:active {\n    color: var(--color-text-active) !important;\n    background-color: var(--color-component-active) !important;\n}\n\n*.disabled > .guifyv2-button {\n    pointer-events: none;\n    background-color: var(--color-component-background-disabled);\n    color: var(--color-text-disabled);\n}", "", {
                       version: 3,
               ...
               442: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, "/* Styling for simple-color-picker */\n\n.guifyv2-color .Scp {\n    width: 125px;\n    height: 100px;\n    -webkit-user-select: none;\n        -moz-user-select: none;\n            -ms-user-select: none;\n                user-select: none;\n    position: relative;\n    z-index: 1000;\n    cursor: pointer;\n}\n.guifyv2-color .Scp-saturation {\n    position: relative;\n    width: calc(100% - 25px);\n    height: 100%;\n    background: linear-gradient(to right, #fff 0%, #f00 100%);\n    float: left;\n    margin-right: 5px;\n}\n.guifyv2-color .Scp-brightness {\n    width: 100%;\n    height: 100%;\n    background: linear-gradient(to top, #000 0%, rgba(255,255,255,0) 100%);\n}\n.guifyv2-color .Scp-sbSelector {\n    border: 1px solid;\n    position: absolute;\n    width: 14px;\n    height: 14px;\n    background: #fff;\n    border-radius: 10px;\n    top: -7px;\n    left: -7px;\n    box-sizing: border-box;\n    z-index: 10;\n}\n.guifyv2-color .Scp-hue {\n    width: 20px;\n    height: 100%;\n    position: relative;\n    float: left;\n    background: linear-gradient(to bottom, #f00 0%, #f0f 17%, #00f 34%, #0ff 50%, #0f0 67%, #ff0 84%, #f00 100%);\n}\n.guifyv2-color .Scp-hSelector {\n    position: absolute;\n    background: #fff;\n    border-bottom: 1px solid #000;\n    right: -3px;\n    width: 10px;\n    height: 2px;\n}\n\n/* Disabled styles */\n.disabled .guifyv2-color {\n    pointer-events: none;\n}", "", {
                       version: 3,
               ...
               144: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ".guifyv2-display {\n    display: inline-block;\n    height: unset;\n    min-height: var(--size-component-height);\n    width: calc(100% - var(--size-label-width));\n    border: none;\n    color: var(--color-text-secondary);\n    font-family: inherit;\n    box-sizing: border-box;\n    -moz-box-sizing: border-box;\n    -webkit-box-sizing: border-box;\n    vertical-align: sub;\n    line-height: 1rem;\n    -webkit-user-select: text;\n       -moz-user-select: text;\n        -ms-user-select: text;\n            user-select: text;\n}\n\n.disabled .guifyv2-display {\n    color: var(--color-text-disabled);\n}", "", {
                       version: 3,
               ...
               191: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ".guifyv2-file-container {\n    display: inline-block;\n    outline: none;\n    padding-top: 8px;\n    padding-bottom: 8px;\n    color: var(--color-text-primary);\n    background-color: var(--color-component-background);\n    cursor: pointer;\n}\n\n.guifyv2-file-container:hover:not(:disabled),\n.guifyv2-file-container:focus:not(:disabled) {\n    color: var(--color-text-hover);\n    background-color: var(--color-component-foreground);\n}\n\n.guifyv2-file-container:active:not(:disabled) {\n    color: var(--color-text-active) !important;\n    background-color: var(--color-component-active) !important;\n}\n\n.guifyv2-dragover:not(:disabled) {\n    background-color: var(--color-component-background);\n    box-shadow: inset 0 0 0 3px var(--color-component-foreground);\n}\n\n.disabled.guifyv2-file-container {\n    pointer-events: none;\n    color: var(--color-text-disabled) !important;\n    background-color: var(--color-component-background-disabled) !important;\n    box-shadow: inset 0 0 0 3px var(--color-component-background-disabled) !important;\n}", "", {
                       version: 3,
               ...
               211: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ".guifyv2-folder {\n    cursor: pointer;\n    padding-left: 0.5em;\n    color: var(--color-text-primary);\n}\n\n.guifyv2-folder div {\n    display: inline-block;\n    vertical-align: sub;\n    line-height: var(--size-component-height);\n}\n\n.guifyv2-folder:hover,\n.guifyv2-folder:focus {\n    color: var(--color-text-hover);\n    background-color: var(--color-component-foreground);\n    outline: none;\n}\n\n\n.guifyv2-folder-contents {\n    display: block;\n    box-sizing: border-box;\n    padding-left: 14px;\n    margin-bottom: 5px;\n    border-left: 2px solid var(--color-component-background);\n}\n\n.guifyv2-folder-contents.guifyv2-folder-closed {\n    height: 0;\n    display: none;\n}\n\n.guifyv2-folder .guifyv2-folder-arrow {\n    width: 1.5em;\n    vertical-align: middle;\n}\n\n/* Disabled styles */\n\n.guifyv2-folder.disabled {\n    pointer-events: none;\n    color: var(--color-text-disabled);\n}\n\n.guifyv2-folder.disabled + .guifyv2-folder-contents {\n    pointer-events: none;\n}", "", {
                       version: 3,
               ...
               115: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ":root {\n    --range-track-color: var(--color-component-background);\n    --range-thumb-color: var(--color-component-foreground);\n    --range-thumb-highlight: var(--color-component-active);\n\n    --range-track-color-disabled: var(--color-component-background-disabled);\n    --range-thumb-color-disabled: var(--color-text-disabled);\n}\n\ninput[type=range].guifyv2-range {\n    position: absolute; /* Gets rid of weird spacing below slider that I can't figure out the source of, seems internal */\n    -webkit-appearance: none;\n    width: 100%;\n    height: var(--size-component-height);\n    margin: 0px 0;\n    padding: 0;\n    display: inline-block;\n\n    /* Fixes for Safari iOS */\n    border-radius: 0;\n    border: none;\n    background-color: transparent;\n}\n\n.disabled input[type=range].guifyv2-range {\n    pointer-events: none;\n}\n\n/* Remove outlines since we'll be adding our own */\ninput[type=range].guifyv2-range:focus {\n    outline: none;\n}\ninput[type=range].guifyv2-range::-moz-focus-outer {\n    border: 0;\n}\n\n/* Webkit */\ninput[type=range].guifyv2-range::-webkit-slider-runnable-track {\n    width: 100%;\n    height: var(--size-component-height);\n    cursor: ew-resize;\n    background: var(--color-component-background);\n    background: var(--range-track-color);\n}\ninput[type=range].guifyv2-range::-webkit-slider-thumb {\n    height: var(--size-component-height);\n    width: 10px;\n    background: var(--color-component-foreground);\n    background: var(--range-thumb-color);\n    cursor: ew-resize;\n    -webkit-appearance: none;\n    margin-top: 0px;\n    border: 0;\n}\ninput[type=range].guifyv2-range:focus::-webkit-slider-runnable-track {\n    background: var(--color-component-active);\n    background: var(--range-thumb-highlight);\n    outline: none;\n}\n\n.disabled input[type=range].guifyv2-range::-webkit-slider-runnable-track { /* Disabled track */\n    pointer-events: none;\n    background: var(--color-component-background-disabled);\n    background: var(--range-track-color-disabled);\n}\n\n.disabled input[type=range].guifyv2-range::-webkit-slider-thumb { /* Disabled thumb */\n    pointer-events: none;\n    background: var(--color-text-disabled);\n}\n\n/* Gecko */\ninput[type=range].guifyv2-range::-moz-range-track {\n    width: 100%;\n    height: var(--size-component-height);\n    cursor: ew-resize;\n    background: var(--color-component-background);\n    background: var(--range-track-color);\n}\ninput[type=range].guifyv2-range:focus::-moz-range-track {\n    background: var(--color-component-active);\n    background: var(--range-thumb-highlight);\n}\ninput[type=range].guifyv2-range::-moz-range-thumb {\n    height: var(--size-component-height);\n    width: 10px;\n    background: var(--color-component-foreground);\n    background: var(--range-thumb-color);\n    cursor: ew-resize;\n    border: none;\n    border-radius: 0;\n}\n\n.disabled input[type=range].guifyv2-range::-moz-range-track { /* Disabled track */\n    pointer-events: none;\n    background: var(--color-component-background-disabled);\n    background: var(--range-track-color-disabled);\n}\n\n.disabled input[type=range].guifyv2-range::-moz-range-thumb { /* Disabled thumb */\n    pointer-events: none;\n    background: var(--color-text-disabled);\n    background: var(--range-thumb-color-disabled);\n}", "", {
                       version: 3,
               ...
               247: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ".guifyv2-select-dropdown {\n    display: inline-block;\n    position: absolute;\n    width: calc(100% - var(--size-label-width));\n    padding-left: 1.5%;\n    height: var(--size-component-height);\n    border: none;\n    border-radius: 0;\n    -webkit-appearance: none;\n    -moz-appearance: none;\n    -o-appearance:none;\n    appearance: none;\n    font-family: inherit;\n    background-color: var(--color-component-background);\n    color: var(--color-text-secondary);\n    box-sizing: border-box !important;\n    -moz-box-sizing: border-box !important;\n    -webkit-box-sizing: border-box !important;\n}\n\n/* Disable default outline since we're providing our own */\n.guifyv2-select-dropdown:focus {\n    outline: none;\n}\n.guifyv2-select-dropdown::-moz-focus-inner {\n    border: 0;\n}\n\n\n.guifyv2-select-dropdown:focus,\n.guifyv2-select-dropdown:hover {\n    color: var(--color-text-hover);\n    background-color: var(--color-component-foreground);\n}\n\n.guifyv2-select-dropdown::-ms-expand {\n    display:none;\n}\n.guifyv2-select-triangle {\n    content: ' ';\n    border-right: 3px solid transparent;\n    border-left: 3px solid transparent;\n    line-height: var(--size-component-height);\n    position: absolute;\n    right: 2.5%;\n    z-index: 1;\n    pointer-events: none;\n}\n\n.guifyv2-select-triangle--up {\n    bottom: 55%;\n    border-bottom: 5px solid var(--color-text-secondary);\n    border-top: 0px transparent;\n}\n\n.guifyv2-select-triangle--down {\n    top: 55%;\n    border-top: 5px solid var(--color-text-secondary);\n    border-bottom: 0px transparent;\n}\n\n.guifyv2-select-triangle--up-highlight {\n    border-bottom-color: var(--color-text-hover);\n}\n\n.guifyv2-select-triangle--down-highlight {\n    border-top-color: var(--color-text-hover);\n}\n\n/* Disabled styles */\n\n.disabled .guifyv2-select-dropdown {\n    pointer-events: none;\n    color: var(--color-text-disabled);\n    background-color: var(--color-component-background-disabled);\n}\n\n.disabled *[class^=\"guifyv2-select-triangle\"] {\n    border-color: var(--color-text-disabled);\n}\n", "", {
                       version: 3,
               ...
               532: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ".guifyv2-text-input {\n    position: absolute;\n    padding-left: 6px;\n    height: var(--size-component-height);\n    width: calc(100% - var(--size-label-width));\n    border: none;\n    background: var(--color-component-background);\n    color: var(--color-text-secondary);\n    font-family: inherit;\n    box-sizing: border-box !important;\n    resize: vertical;\n\n    /* Fixes for Safari iOS */\n    border-radius: 0;\n}\n\n.guifyv2-text-input:focus {\n    outline: none;\n}\n\n.disabled .guifyv2-text-input {\n    pointer-events: none;\n    color: var(--color-text-disabled);\n    background-color: var(--color-component-background-disabled);\n}", "", {
                       version: 3,
               ...
               72: (n, e, t) => {
                   ...
                   var o = t(537),
                       ...
                       c = t(19),
                       s = a()(r());
                   s.i(c.Z), s.push([n.id, ".guifyv2-container {\n    position: absolute;\n    left: 0;\n    width: 100%;\n    height: 100%;\n}\n\n/* Sub-elements of guifyv2-container should appear over anything else. */\n.guifyv2-container > * {\n    z-index: 9999;\n}\n\n.guifyv2-container, .guifyv2-container * {\n    font-family: var(--font-family);\n    font-size: var(--font-size);\n    font-weight: var(--font-weight);\n}\n\n.guifyv2-container-overlay {\n    height: 100%;\n}\n\n.guifyv2-container-above {\n    height: calc(100% + var(--size-menu-bar-height));\n    bottom: 0;\n}\n\n/* Overlay container when fullscreen */\n.guifyv2-fullscreen .guifyv2-container {\n    position: fixed;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n}", "", {
                       version: 3,
       ...
       return (() => {
           ...
           const _ = function(n, e, t) {
               ...
               return o.classList.add("guifyv2-component-container"), o
           };
           ...
           var V = function(n) {
                   ...
                   function r(n, e, t) {
                       ...
                       a.classList.add("guifyv2-title");
                       var c = a.appendChild(document.createElement("div"));
                       return c.classList.add("guifyv2-title-text"), c.innerHTML = "&#9632; ".concat(e.label, " &#9632;"), i
                   }
                   return r
               }(j),
               W = t(114),
           ...
           const X = function(n, e, t) {
               var o = n.appendChild(document.createElement("div"));
               return o.classList.add("guifyv2-component-label"), o.innerHTML = e, o
           };
           var G = t(643),
               Q = {};
           ...
           const J = function(n, t, o, r, i) {
               ...
               return a.type = "text", a.classList.add("guifyv2-value-input"), a.value = t, i || a.classList.add("guifyv2-value-input-right"), e()(a, {
                   width: r
               }), a
           };
           ...
           var rn = function(n) {
                   ...
                   function c(n, t, o) {
                       ...
                       if (function(n, e) {
                               if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                           }(this, c), (r = a.call(this, n, t, o)).scale = t.scale, r.label = X(r.container, t.label), r.input = r.container.appendChild(document.createElement("input")), r.input.type = "range", r.input.classList.add("guifyv2-range"), t.label && r.input.setAttribute("aria-label", t.label + " input"), "log" === t.scale) {
           ...
           var pn = function(n) {
                   ...
                   function r(n, e, t) {
                       ...
                       return function(n, e) {
                           if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                       }(this, r), (i = o.call(this, n, e, t)).label = X(i.container, ""), i.input = i.container.appendChild(document.createElement("button")), i.input.classList.add("guifyv2-button"), i.input.textContent = e.label, i.button = i.input, i.input.addEventListener("click", e.action), i.input.addEventListener("mouseup", (function() {
                           i.input.blur()
                       })), i
                   }
                   return r
           ...
           var yn = function(n) {
                   ...
                   function a(n, e, t) {
                       ...
                       return function(n, e) {
                           if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                       }(this, a), (o = i.call(this, n, e, t)).label = X(o.container, e.label), o.input = o.container.appendChild(document.createElement("input")), o.input.id = "guifyv2-checkbox-" + e.label + o.uuid, o.input.type = "checkbox", o.input.checked = e.initial, o.input.classList.add("guifyv2-checkbox"), e.label && o.input.setAttribute("aria-label", e.label), o.container.appendChild(document.createElement("label")).htmlFor = o.input.id, setTimeout((function() {
           ...
           var _n = function(n) {
                   ...
                   function a(n, e, t) {
                       ...
                       if (function(n, e) {
                               if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                           }(this, a), (o = i.call(this, n, e, t)).label = X(o.container, e.label), o.input = document.createElement("select"), o.input.classList.add("guifyv2-select-dropdown"), e.label && o.input.setAttribute("aria-label", e.label), (c = document.createElement("span")).classList.add("guifyv2-select-triangle", "guifyv2-select-triangle--down"), (s = document.createElement("span")).classList.add("guifyv2-select-triangle", "guifyv2-select-triangle--up"), o.container.appendChild(c), o.container.appendChild(s), Array.isArray(e.options))
                       ...
                       var A = function() {
                               c.classList.add("guifyv2-select-triangle--down-highlight"), s.classList.add("guifyv2-select-triangle--up-highlight")
                           },
                           d = function() {
                               c.classList.remove("guifyv2-select-triangle--down-highlight"), s.classList.remove("guifyv2-select-triangle--up-highlight")
                           },
                           h = !1;
           ...
           var de = function(n) {
                   ...
                   function a(n, e, t) {
                       ...
                       return function(n, e) {
                           if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                       }(this, a), (o = i.call(this, n, e, t)).container.classList.add("guifyv2-folder"), o.container.setAttribute("role", "button"), o.container.setAttribute("tabIndex", "0"), o.arrow = o.container.appendChild(document.createElement("div")), o.arrow.classList.add("guifyv2-folder-arrow"), o.arrow.innerHTML = "&#9662;", o.label = o.container.appendChild(document.createElement("div")), o.label.classList.add("guifyv2-folder-text"), o.label.innerHTML = e.label, o.container.onclick = function() {
                           o.Toggle()
                       ...
                       })), o.folderContainer = n.appendChild(document.createElement("div")), o.folderContainer.classList.add("guifyv2-folder-contents"), o.open = o.opts.open || !1, o.SetOpen(o.open), o
                   }
                   return e = a, (t = [{
                       key: "SetEnabled",
                       value: function(n) {
                       ...
                       key: "SetOpen",
                       value: function(n) {
                           this.open = n, n ? (this.folderContainer.classList.remove("guifyv2-folder-closed"), this.arrow.innerHTML = "&#9662;") : (this.folderContainer.classList.add("guifyv2-folder-closed"), this.arrow.innerHTML = "&#9656;")
                       }
                   }, {
                       key: "Remove",
                       value: function() {
           ...
           var xe = function(n) {
                   ...
                   function c(n, t, o) {
                       ...
                       ! function(n, e) {
                           if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                       }(this, c), (r = a.call(this, n, t, o)).opts.fileReadFunc = r.opts.fileReadFunc || "readAsDataURL", r.file = null, r.fileName = null, r.container.classList.add("guifyv2-file-container"), r.container.setAttribute("role", "button"), r.container.setAttribute("tabIndex", "0"), e()(r.container, {
                           width: "100%",
                           "box-sizing": "border-box",
                           "-moz-box-sizing": "border-box",
                           "-webkit-box-sizing": "border-box",
                       ...
                       return r.input.addEventListener("change", s), r.container.addEventListener("dragover", (function(n) {
                           n.preventDefault(), n.stopPropagation(), r.container.classList.add("guifyv2-dragover")
                       })), r.container.addEventListener("dragleave", (function(n) {
                           n.preventDefault(), n.stopPropagation(), r.container.classList.remove("guifyv2-dragover")
                       })), r.container.addEventListener("drop", (function(n) {
                           n.preventDefault(), n.stopPropagation(), r.container.classList.remove("guifyv2-dragover"), s(n)
           ...
           var ze = function(n) {
                   ...
                   function a(n, e, t) {
                       ...
                       return function(n, e) {
                           if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                       }(this, a), (o = i.call(this, n, e, t)).label = X(o.container, e.label), o.text = o.container.appendChild(document.createElement("div")), o.text.classList.add("guifyv2-display"), e.initial && o.SetValue(e.initial), e.label && o.text.setAttribute("aria-label", e.label), o
                   }
                   return e = a, t = [{
                       key: "SetValue",
                       value: function(n) {
           ...
           var He = function(n) {
               ...
               function c(n, e, t) {
                   ...
                   if (o.input = o.container.appendChild(document.createElement("span")), o.input.classList.add("guifyv2-interval"), o.handle = document.createElement("span"), o.handle.classList.add("guifyv2-interval-handle"), o.input.appendChild(o.handle), Array.isArray(e.initial) || (e.initial = []), o.scale = e.scale, "log" === e.scale) {
           ...
           var Qe = function(n) {
                   ...
                   function c(n, t, o) {
                       ...
                       if (function(n, e) {
                               if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                           }(this, c), (r = a.call(this, n, t, o, !1)).element = document.createElement("div"), r.element.classList.add("guifyv2-bar"), n.appendChild(r.element), t.title) {
                           var i = r.element.appendChild(document.createElement("div"));
                           i.classList.add("guifyv2-bar-title"), i.innerHTML = t.title, r.label = i
                       }
                       var s = r.element.appendChild(document.createElement("button"));
                       if (s.classList.add("guifyv2-bar-button"), s.innerHTML = "Controls", e()(s, {
                           ...
                           l.classList.add("guifyv2-bar-button"), l.innerHTML = "「　」", l.setAttribute("aria-label", "Toggle Fullscreen"), e()(l, {
           ...
           var it = function(n) {
                   ...
                   function c(n, t, o) {
                       ...
                       return function(n, e) {
                           if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                       }(this, c), (r = a.call(this, n, t, o, !1)).container = n.appendChild(document.createElement("div")), r.container.classList.add("guifyv2-panel-container"), e()(r.container, {
                           width: t.width,
                           opacity: t.opacity || 1
                       }), "left" == t.align ? "outer" == t.panelMode ? r.container.classList.add("guifyv2-panel-container-left-outer") : "inner" == t.panelMode && r.container.classList.add("guifyv2-panel-container-left-inner") : "outer" == t.panelMode ? r.container.classList.add("guifyv2-panel-container-right-outer") : "inner" == t.panelMode && r.container.classList.add("guifyv2-panel-container-right-inner"), "scroll" == t.panelOverflowBehavior && r.container.classList.add("guifyv2-panel-container-scrollable"), "none" === t.barMode && e()(r.container, {
                           maxHeight: "100%"
                       }), r.panel = r.container.appendChild(document.createElement("div")), r.panel.classList.add("guifyv2-panel"), "none" === t.barMode && t.title && function(n, t, o) {
                   ...
                   return t = c, (o = [{
                       key: "SetVisible",
                       value: function(n) {
                           n ? (this.panel.classList.remove("guifyv2-panel-hidden"), this.menuButton && this.menuButton.setAttribute("alt", "Close GUI")) : (this.panel.classList.add("guifyv2-panel-hidden"), this.menuButton && this.menuButton.setAttribute("alt", "Open GUI"))
                       }
                   }, {
                       key: "ToggleVisible",
                       value: function() {
                           this.panel.classList.contains("guifyv2-panel-hidden") ? this.SetVisible(!0) : this.SetVisible(!1)
                       }
                   }, {
                       key: "_MakeToggleButton",
                       value: function() {
                           var n = this;
                           this.menuButton = this.container.appendChild(document.createElement("button")), this.menuButton.className = "guifyv2-panel-toggle-button", e()(this.menuButton, {
           ...
           var At = function(n) {
               ...
               function c(n, t, o) {
                   ...
                   return function(n, e) {
                       if (!(n instanceof e)) throw new TypeError("Cannot call a class as a function")
                   }(this, c), (r = a.call(this, n, t, o, !1)).element = n.appendChild(document.createElement("div")), r.element.classList.add("guifyv2-toast-area"), e()(r.element, {
                       position: "absolute",
                       width: "100%"
                   }), r
               }
               return t = c, o = [{
                   ...
                   value: function(n) {
                       ...
                       r.classList.add("guifyv2-toast-notification"), r.setAttribute("aria-live", "polite"), r.innerHTML = n, e()(r, {});
                       var i, a = r.appendChild(document.createElement("button"));
                       a.innerHTML = "&#10006;", a.classList.add("guifyv2-toast-close-button");
                       var c = function() {
                           r.blur(), e()(r, {
                               opacity: "0"
           ...
           var ht = function() {
                   function n(e) {
                       ...
                       this.theme = new c(o), this.theme.Apply(), this._ConstructElements(), this._LoadStyles(), We().isEnabled && We().on("change", (function() {
                           t.opts.root.classList.toggle("guifyv2-fullscreen", We().isFullscreen)
                   ...
                   return t = n, o = [{
                       ...
                       value: function() {
                           var n = this;
                           if (this.container = document.createElement("div"), this.container.classList.add("guifyv2-container"), this.hasRoot && "above" == this.opts.barMode) this.container.classList.add("guifyv2-container-above");
                           else if (this.hasRoot && "overlay" == this.opts.barMode) this.container.classList.add("guifyv2-container-overlay");
                           else if (this.hasRoot && "offset" == this.opts.barMode) {
                               this.container.classList.add("guifyv2-container-above"), console.log(window.getComputedStyle(this.opts.root).getPropertyValue("margin-top"));
